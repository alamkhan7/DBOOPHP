...
class Car {
    ...
    // this will execute automatically when you are setting properties value
    ...
    public function __toString()
    {
        ...
        $output .= 'Make: ' . $this->make . '<br>';         // access to class properties will first execute get method 
